...
mind_and_body_metadata <- read.csv("https://raw.githubusercontent.com/regan008/8510-TextAnalysisData/main/mb-metadata.csv")

mb <- readtext(paste(getwd(), "/txt/*.txt", sep=""))
mind_body <- 
  mind_and_body_metadata |> 
  arrange(Filename) |> 
  full_join(mb, by = c("Filename" = "doc_id")) |> 
  as_tibble()
